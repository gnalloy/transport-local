...
- Import path: `gnalloy.org/transport-local`
- Repository: `github.com/gnalloy/transport-local`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/transport-local@dev`
- License: Apache-2.0

## Install
```bash
go get gnalloy.org/transport-local@dev
go doc gnalloy.org/transport-local
...
This repository owns: In-process local paired-channel transport for Gnalloy tests and embedded deployments.
